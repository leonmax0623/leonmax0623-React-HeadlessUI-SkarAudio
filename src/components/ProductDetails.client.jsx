...
function AddToCartMarkup() {
  ...
  return (
    <div className="space-y-2 mb-8 flex">
      {!isOutOfStock ? <ProductQuantitySelector quantity={quantity} setQuantity={setQuantity} /> : <></>}
        ...
        <div className="grid grid-cols-1 md:grid-cols-[3fr,2fr] gap-x-8 my-16">
          ...
          <div>
            <div className="hidden md:block">
              <Product.Title
                as="h1"
                className="text-4xl font-bold text-black mb-4 font-oswald-light letter-spacing-2x uppercase"
              />
              {/*{product.vendor && (
                <div className="text-sm font-medium mb-2 text-gray-900">
                  {product.vendor}
